...
sylar::ConfigVar<std::vector<int>>::ptr g_vec_int_value_config =
    sylar::Config::Lookup("system.int_vec", std::vector<int>{10, 20, 30}, "system value");
...
sylar::ConfigVar<std::map<std::string, int>>::ptr g_str_int_m_value_config =
    sylar::Config::Lookup("system.int_map", std::map<std::string, int>{{"key", 2}}, "system value");

sylar::ConfigVar<std::unordered_map<std::string, int>>::ptr g_str_int_um_value_config =
    sylar::Config::Lookup("system.int_umap", std::unordered_map<std::string, int>{{"key", 2}}, "system value");
...
#define XX_M(g_var, name, prefix)                                                        \
  ...
  XX_M(g_str_int_m_value_config, int_map, before);
  XX_M(g_str_int_um_value_config, int_map, before);
  YAML::Node root = YAML::LoadFile("/home/xiejw/work/sylar/bin/conf/log.yml");
  ...
  XX_M(g_str_int_m_value_config, int_map, after);
  XX_M(g_str_int_um_value_config, int_map, after);
}
